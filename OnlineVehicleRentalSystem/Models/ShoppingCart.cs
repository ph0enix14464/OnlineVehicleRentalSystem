...
namespace OnlineVehicleRentalSystem.Models
{
    ...
    {
        OnlineVehicleDBEntities storeDB = new OnlineVehicleDBEntities();
        ...
        public void AddToCart(tblVehicle item)
        {
        ...
        public decimal GetTotal()
        {
            ...
            decimal? total = (from cartItems in storeDB.tblCarts
                              where cartItems.CartId == ShoppingCartId
                              select (int?)cartItems.Count * cartItems.tblVehicle.Price).Sum();
        ...
        public int CreateOrder(tblOrder order)
        {
            ...
            foreach (var item in cartItems)
            {
                var orderDetail = new tblOrderDetail
                {
                    ...
                    UnitPrice = item.tblVehicle.Price,
                    Quantity = item.Count
                };
                // Set the order total of the shopping cart 
                orderTotal += Convert.ToDecimal(item.Count * (item.tblVehicle.Price));
