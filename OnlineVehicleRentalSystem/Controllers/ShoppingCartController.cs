...
namespace OnlineVehicleRentalSystem.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult AddToCart(int id)
        {
            ...
            var addedItem = storeDB.tblVehicles
        ...
        public ActionResult UpdateCartCount(int id, int cartCount)
        {
            ...
            try
            {
                ...
                string itemName = storeDB.tblCarts
                    .Single(item => item.RecordId == id).tblVehicle.Title;
        ...
        public ActionResult RemoveFromCart(int id)
        {
            ...
            // Get the name of the album to display confirmation 
            string albumName = storeDB.tblCarts.Single(item => item.RecordId == id).tblVehicle.Title;
